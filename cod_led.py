...
class cod_led(QMainWindow,Ui_MainWindow):
	def __init__(self, arg):
		...
		self.btn_dosql.clicked.connect(self.importtodb)

		self.rd_five_start.clicked.connect(lambda:self.fivebtn(self.rd_five_start))
		self.rd_five_stop.clicked.connect(lambda:self.fivebtn(self.rd_five_stop))
		self.rd_five_clear.clicked.connect(lambda:self.fivebtn(self.rd_five_clear))
		self.rd_five_reset.clicked.connect(lambda:self.fivebtn(self.rd_five_reset))

		self.rd_twenty_start.clicked.connect(lambda:self.twentybtn(self.rd_twenty_start))
		self.rd_twenty_stop.clicked.connect(lambda:self.twentybtn(self.rd_twenty_stop))
		self.rd_twenty_clear.clicked.connect(lambda:self.twentybtn(self.rd_twenty_clear))
		self.rd_twenty_reset.clicked.connect(lambda:self.twentybtn(self.rd_twenty_reset))

		self.rd_scrolling_start.clicked.connect(lambda:self.scrollingbtn(self.rd_scrolling_start))
		self.rd_scrolling_stop.clicked.connect(lambda:self.scrollingbtn(self.rd_scrolling_stop))


	def fivebtn(self,btn):
		if btn.text() == "复位":
			args = {
				"fivestart": "fivestart",
